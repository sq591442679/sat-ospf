...
void Ospfv2Interface::reset()
{
     ...
     * @sqsq
     */
//    int direction = interfaceName[4] - '0';
//    DesignatedRouterId DR;
//    DR.routerID = parentArea->getRouter()->getRouterID();
//    DR.ipInterfaceAddress = parentArea->getNetworkByRouterID()->find(DR.routerID)->second[direction];
//    setDesignatedRouter(DR);
//    setBackupDesignatedRouter(DR);
}
 ...
 */
bool Ospfv2Interface::floodLsa(const Ospfv2Lsa *lsa, int current_ttl /* = -1 */, Ospfv2Interface *intf, Neighbor *neighbor)
{
    /*
     * @sqsq

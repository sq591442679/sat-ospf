...
class INET_API Ospfv2Interface
{
  ...
  public:
     ...
     * @sqsq
     */
    Ospfv2InterfaceState *getStatePointer() { return state; }
    ...
    bool floodLsa(const Ospfv2Lsa *lsa, int current_ttl = -1, Ospfv2Interface *intf = nullptr, Neighbor *neighbor = nullptr);
     ...
     * @sqsq
     */
    void setDesignatedRouter(DesignatedRouterId designatedRouterId) { designatedRouter = designatedRouterId; }
    void setBackupDesignatedRouter(DesignatedRouterId backupDesignatedRouterId) { backupDesignatedRouter = backupDesignatedRouterId; }

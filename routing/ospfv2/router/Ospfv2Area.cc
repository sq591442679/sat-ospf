    ...
    parentRouter(nullptr)
{
     ...
     */
//    networkMap.clear();
//    networkMap[Ipv4Address(192, 168, 1, 0)] = std::make_pair(Ipv4Address(0, 0, 1, 1), Ipv4Address(0, 0, 1, 2));
//    networkMap[Ipv4Address(192, 168, 2, 0)] = std::make_pair(Ipv4Address(0, 0, 1, 1), Ipv4Address(0, 0, 2, 1));
//    networkMap[Ipv4Address(192, 168, 3, 0)] = std::make_pair(Ipv4Address(0, 0, 1, 2), Ipv4Address(0, 0, 1, 3));
//    networkMap[Ipv4Address(192, 168, 4, 0)] = std::make_pair(Ipv4Address(0, 0, 1, 2), Ipv4Address(0, 0, 2, 2));
//    networkMap[Ipv4Address(192, 168, 5, 0)] = std::make_pair(Ipv4Address(0, 0, 1, 3), Ipv4Address(0, 0, 1, 4));
//    networkMap[Ipv4Address(192, 168, 6, 0)] = std::make_pair(Ipv4Address(0, 0, 1, 3), Ipv4Address(0, 0, 2, 3));
//    networkMap[Ipv4Address(192, 168, 7, 0)] = std::make_pair(Ipv4Address(0, 0, 1, 4), Ipv4Address(0, 0, 1, 5));
//    networkMap[Ipv4Address(192, 168, 8, 0)] = std::make_pair(Ipv4Address(0, 0, 1, 4), Ipv4Address(0, 0, 2, 4));
//    networkMap[Ipv4Address(192, 168, 9, 0)] = std::make_pair(Ipv4Address(0, 0, 1, 5), Ipv4Address(0, 0, 1, 6));
//    networkMap[Ipv4Address(192, 168, 10, 0)] = std::make_pair(Ipv4Address(0, 0, 1, 5), Ipv4Address(0, 0, 2, 5));
//    networkMap[Ipv4Address(192, 168, 11, 0)] = std::make_pair(Ipv4Address(0, 0, 1, 6), Ipv4Address(0, 0, 1, 1));
//    networkMap[Ipv4Address(192, 168, 12, 0)] = std::make_pair(Ipv4Address(0, 0, 1, 6), Ipv4Address(0, 0, 2, 6));
//    networkMap[Ipv4Address(192, 168, 13, 0)] = std::make_pair(Ipv4Address(0, 0, 2, 1), Ipv4Address(0, 0, 2, 2));
//    networkMap[Ipv4Address(192, 168, 14, 0)] = std::make_pair(Ipv4Address(0, 0, 2, 1), Ipv4Address(0, 0, 3, 1));
//    networkMap[Ipv4Address(192, 168, 15, 0)] = std::make_pair(Ipv4Address(0, 0, 2, 2), Ipv4Address(0, 0, 2, 3));
//    networkMap[Ipv4Address(192, 168, 16, 0)] = std::make_pair(Ipv4Address(0, 0, 2, 2), Ipv4Address(0, 0, 3, 2));
//    networkMap[Ipv4Address(192, 168, 17, 0)] = std::make_pair(Ipv4Address(0, 0, 2, 3), Ipv4Address(0, 0, 2, 4));
//    networkMap[Ipv4Address(192, 168, 18, 0)] = std::make_pair(Ipv4Address(0, 0, 2, 3), Ipv4Address(0, 0, 3, 3));
//    networkMap[Ipv4Address(192, 168, 19, 0)] = std::make_pair(Ipv4Address(0, 0, 2, 4), Ipv4Address(0, 0, 2, 5));
//    networkMap[Ipv4Address(192, 168, 20, 0)] = std::make_pair(Ipv4Address(0, 0, 2, 4), Ipv4Address(0, 0, 3, 4));
//    networkMap[Ipv4Address(192, 168, 21, 0)] = std::make_pair(Ipv4Address(0, 0, 2, 5), Ipv4Address(0, 0, 2, 6));
//    networkMap[Ipv4Address(192, 168, 22, 0)] = std::make_pair(Ipv4Address(0, 0, 2, 5), Ipv4Address(0, 0, 3, 5));
//    networkMap[Ipv4Address(192, 168, 23, 0)] = std::make_pair(Ipv4Address(0, 0, 2, 6), Ipv4Address(0, 0, 2, 1));
//    networkMap[Ipv4Address(192, 168, 24, 0)] = std::make_pair(Ipv4Address(0, 0, 2, 6), Ipv4Address(0, 0, 3, 6));
//    networkMap[Ipv4Address(192, 168, 25, 0)] = std::make_pair(Ipv4Address(0, 0, 3, 1), Ipv4Address(0, 0, 3, 2));
//    networkMap[Ipv4Address(192, 168, 26, 0)] = std::make_pair(Ipv4Address(0, 0, 3, 1), Ipv4Address(0, 0, 4, 1));
//    networkMap[Ipv4Address(192, 168, 27, 0)] = std::make_pair(Ipv4Address(0, 0, 3, 2), Ipv4Address(0, 0, 3, 3));
//    networkMap[Ipv4Address(192, 168, 28, 0)] = std::make_pair(Ipv4Address(0, 0, 3, 2), Ipv4Address(0, 0, 4, 2));
//    networkMap[Ipv4Address(192, 168, 29, 0)] = std::make_pair(Ipv4Address(0, 0, 3, 3), Ipv4Address(0, 0, 3, 4));
//    networkMap[Ipv4Address(192, 168, 30, 0)] = std::make_pair(Ipv4Address(0, 0, 3, 3), Ipv4Address(0, 0, 4, 3));
//    networkMap[Ipv4Address(192, 168, 31, 0)] = std::make_pair(Ipv4Address(0, 0, 3, 4), Ipv4Address(0, 0, 3, 5));
//    networkMap[Ipv4Address(192, 168, 32, 0)] = std::make_pair(Ipv4Address(0, 0, 3, 4), Ipv4Address(0, 0, 4, 4));
//    networkMap[Ipv4Address(192, 168, 33, 0)] = std::make_pair(Ipv4Address(0, 0, 3, 5), Ipv4Address(0, 0, 3, 6));
//    networkMap[Ipv4Address(192, 168, 34, 0)] = std::make_pair(Ipv4Address(0, 0, 3, 5), Ipv4Address(0, 0, 4, 5));
//    networkMap[Ipv4Address(192, 168, 35, 0)] = std::make_pair(Ipv4Address(0, 0, 3, 6), Ipv4Address(0, 0, 3, 1));
//    networkMap[Ipv4Address(192, 168, 36, 0)] = std::make_pair(Ipv4Address(0, 0, 3, 6), Ipv4Address(0, 0, 4, 6));
//    networkMap[Ipv4Address(192, 168, 37, 0)] = std::make_pair(Ipv4Address(0, 0, 4, 1), Ipv4Address(0, 0, 4, 2));
//    networkMap[Ipv4Address(192, 168, 38, 0)] = std::make_pair(Ipv4Address(0, 0, 4, 1), Ipv4Address(0, 0, 5, 1));
//    networkMap[Ipv4Address(192, 168, 39, 0)] = std::make_pair(Ipv4Address(0, 0, 4, 2), Ipv4Address(0, 0, 4, 3));
//    networkMap[Ipv4Address(192, 168, 40, 0)] = std::make_pair(Ipv4Address(0, 0, 4, 2), Ipv4Address(0, 0, 5, 2));
//    networkMap[Ipv4Address(192, 168, 41, 0)] = std::make_pair(Ipv4Address(0, 0, 4, 3), Ipv4Address(0, 0, 4, 4));
//    networkMap[Ipv4Address(192, 168, 42, 0)] = std::make_pair(Ipv4Address(0, 0, 4, 3), Ipv4Address(0, 0, 5, 3));
//    networkMap[Ipv4Address(192, 168, 43, 0)] = std::make_pair(Ipv4Address(0, 0, 4, 4), Ipv4Address(0, 0, 4, 5));
//    networkMap[Ipv4Address(192, 168, 44, 0)] = std::make_pair(Ipv4Address(0, 0, 4, 4), Ipv4Address(0, 0, 5, 4));
//    networkMap[Ipv4Address(192, 168, 45, 0)] = std::make_pair(Ipv4Address(0, 0, 4, 5), Ipv4Address(0, 0, 4, 6));
//    networkMap[Ipv4Address(192, 168, 46, 0)] = std::make_pair(Ipv4Address(0, 0, 4, 5), Ipv4Address(0, 0, 5, 5));
//    networkMap[Ipv4Address(192, 168, 47, 0)] = std::make_pair(Ipv4Address(0, 0, 4, 6), Ipv4Address(0, 0, 4, 1));
//    networkMap[Ipv4Address(192, 168, 48, 0)] = std::make_pair(Ipv4Address(0, 0, 4, 6), Ipv4Address(0, 0, 5, 6));
//    networkMap[Ipv4Address(192, 168, 49, 0)] = std::make_pair(Ipv4Address(0, 0, 5, 1), Ipv4Address(0, 0, 5, 2));
//    networkMap[Ipv4Address(192, 168, 50, 0)] = std::make_pair(Ipv4Address(0, 0, 5, 1), Ipv4Address(0, 0, 6, 1));
//    networkMap[Ipv4Address(192, 168, 51, 0)] = std::make_pair(Ipv4Address(0, 0, 5, 2), Ipv4Address(0, 0, 5, 3));
//    networkMap[Ipv4Address(192, 168, 52, 0)] = std::make_pair(Ipv4Address(0, 0, 5, 2), Ipv4Address(0, 0, 6, 2));
//    networkMap[Ipv4Address(192, 168, 53, 0)] = std::make_pair(Ipv4Address(0, 0, 5, 3), Ipv4Address(0, 0, 5, 4));
//    networkMap[Ipv4Address(192, 168, 54, 0)] = std::make_pair(Ipv4Address(0, 0, 5, 3), Ipv4Address(0, 0, 6, 3));
//    networkMap[Ipv4Address(192, 168, 55, 0)] = std::make_pair(Ipv4Address(0, 0, 5, 4), Ipv4Address(0, 0, 5, 5));
//    networkMap[Ipv4Address(192, 168, 56, 0)] = std::make_pair(Ipv4Address(0, 0, 5, 4), Ipv4Address(0, 0, 6, 4));
//    networkMap[Ipv4Address(192, 168, 57, 0)] = std::make_pair(Ipv4Address(0, 0, 5, 5), Ipv4Address(0, 0, 5, 6));
//    networkMap[Ipv4Address(192, 168, 58, 0)] = std::make_pair(Ipv4Address(0, 0, 5, 5), Ipv4Address(0, 0, 6, 5));
//    networkMap[Ipv4Address(192, 168, 59, 0)] = std::make_pair(Ipv4Address(0, 0, 5, 6), Ipv4Address(0, 0, 5, 1));
//    networkMap[Ipv4Address(192, 168, 60, 0)] = std::make_pair(Ipv4Address(0, 0, 5, 6), Ipv4Address(0, 0, 6, 6));
//    networkMap[Ipv4Address(192, 168, 61, 0)] = std::make_pair(Ipv4Address(0, 0, 6, 1), Ipv4Address(0, 0, 6, 2));
//    networkMap[Ipv4Address(192, 168, 62, 0)] = std::make_pair(Ipv4Address(0, 0, 6, 1), Ipv4Address(0, 0, 7, 1));
//    networkMap[Ipv4Address(192, 168, 63, 0)] = std::make_pair(Ipv4Address(0, 0, 6, 2), Ipv4Address(0, 0, 6, 3));
//    networkMap[Ipv4Address(192, 168, 64, 0)] = std::make_pair(Ipv4Address(0, 0, 6, 2), Ipv4Address(0, 0, 7, 2));
//    networkMap[Ipv4Address(192, 168, 65, 0)] = std::make_pair(Ipv4Address(0, 0, 6, 3), Ipv4Address(0, 0, 6, 4));
//    networkMap[Ipv4Address(192, 168, 66, 0)] = std::make_pair(Ipv4Address(0, 0, 6, 3), Ipv4Address(0, 0, 7, 3));
//    networkMap[Ipv4Address(192, 168, 67, 0)] = std::make_pair(Ipv4Address(0, 0, 6, 4), Ipv4Address(0, 0, 6, 5));
//    networkMap[Ipv4Address(192, 168, 68, 0)] = std::make_pair(Ipv4Address(0, 0, 6, 4), Ipv4Address(0, 0, 7, 4));
//    networkMap[Ipv4Address(192, 168, 69, 0)] = std::make_pair(Ipv4Address(0, 0, 6, 5), Ipv4Address(0, 0, 6, 6));
//    networkMap[Ipv4Address(192, 168, 70, 0)] = std::make_pair(Ipv4Address(0, 0, 6, 5), Ipv4Address(0, 0, 7, 5));
//    networkMap[Ipv4Address(192, 168, 71, 0)] = std::make_pair(Ipv4Address(0, 0, 6, 6), Ipv4Address(0, 0, 6, 1));
//    networkMap[Ipv4Address(192, 168, 72, 0)] = std::make_pair(Ipv4Address(0, 0, 6, 6), Ipv4Address(0, 0, 7, 6));
//    networkMap[Ipv4Address(192, 168, 73, 0)] = std::make_pair(Ipv4Address(0, 0, 7, 1), Ipv4Address(0, 0, 7, 2));
//    networkMap[Ipv4Address(192, 168, 74, 0)] = std::make_pair(Ipv4Address(0, 0, 7, 1), Ipv4Address(0, 0, 8, 1));
//    networkMap[Ipv4Address(192, 168, 75, 0)] = std::make_pair(Ipv4Address(0, 0, 7, 2), Ipv4Address(0, 0, 7, 3));
//    networkMap[Ipv4Address(192, 168, 76, 0)] = std::make_pair(Ipv4Address(0, 0, 7, 2), Ipv4Address(0, 0, 8, 2));
//    networkMap[Ipv4Address(192, 168, 77, 0)] = std::make_pair(Ipv4Address(0, 0, 7, 3), Ipv4Address(0, 0, 7, 4));
//    networkMap[Ipv4Address(192, 168, 78, 0)] = std::make_pair(Ipv4Address(0, 0, 7, 3), Ipv4Address(0, 0, 8, 3));
//    networkMap[Ipv4Address(192, 168, 79, 0)] = std::make_pair(Ipv4Address(0, 0, 7, 4), Ipv4Address(0, 0, 7, 5));
//    networkMap[Ipv4Address(192, 168, 80, 0)] = std::make_pair(Ipv4Address(0, 0, 7, 4), Ipv4Address(0, 0, 8, 4));
//    networkMap[Ipv4Address(192, 168, 81, 0)] = std::make_pair(Ipv4Address(0, 0, 7, 5), Ipv4Address(0, 0, 7, 6));
//    networkMap[Ipv4Address(192, 168, 82, 0)] = std::make_pair(Ipv4Address(0, 0, 7, 5), Ipv4Address(0, 0, 8, 5));
//    networkMap[Ipv4Address(192, 168, 83, 0)] = std::make_pair(Ipv4Address(0, 0, 7, 6), Ipv4Address(0, 0, 7, 1));
//    networkMap[Ipv4Address(192, 168, 84, 0)] = std::make_pair(Ipv4Address(0, 0, 7, 6), Ipv4Address(0, 0, 8, 6));
//    networkMap[Ipv4Address(192, 168, 85, 0)] = std::make_pair(Ipv4Address(0, 0, 8, 1), Ipv4Address(0, 0, 8, 2));
//    networkMap[Ipv4Address(192, 168, 86, 0)] = std::make_pair(Ipv4Address(0, 0, 8, 1), Ipv4Address(0, 0, 9, 1));
//    networkMap[Ipv4Address(192, 168, 87, 0)] = std::make_pair(Ipv4Address(0, 0, 8, 2), Ipv4Address(0, 0, 8, 3));
//    networkMap[Ipv4Address(192, 168, 88, 0)] = std::make_pair(Ipv4Address(0, 0, 8, 2), Ipv4Address(0, 0, 9, 2));
//    networkMap[Ipv4Address(192, 168, 89, 0)] = std::make_pair(Ipv4Address(0, 0, 8, 3), Ipv4Address(0, 0, 8, 4));
//    networkMap[Ipv4Address(192, 168, 90, 0)] = std::make_pair(Ipv4Address(0, 0, 8, 3), Ipv4Address(0, 0, 9, 3));
//    networkMap[Ipv4Address(192, 168, 91, 0)] = std::make_pair(Ipv4Address(0, 0, 8, 4), Ipv4Address(0, 0, 8, 5));
//    networkMap[Ipv4Address(192, 168, 92, 0)] = std::make_pair(Ipv4Address(0, 0, 8, 4), Ipv4Address(0, 0, 9, 4));
//    networkMap[Ipv4Address(192, 168, 93, 0)] = std::make_pair(Ipv4Address(0, 0, 8, 5), Ipv4Address(0, 0, 8, 6));
//    networkMap[Ipv4Address(192, 168, 94, 0)] = std::make_pair(Ipv4Address(0, 0, 8, 5), Ipv4Address(0, 0, 9, 5));
//    networkMap[Ipv4Address(192, 168, 95, 0)] = std::make_pair(Ipv4Address(0, 0, 8, 6), Ipv4Address(0, 0, 8, 1));
//    networkMap[Ipv4Address(192, 168, 96, 0)] = std::make_pair(Ipv4Address(0, 0, 8, 6), Ipv4Address(0, 0, 9, 6));
//    networkMap[Ipv4Address(192, 168, 97, 0)] = std::make_pair(Ipv4Address(0, 0, 9, 1), Ipv4Address(0, 0, 9, 2));
//    networkMap[Ipv4Address(192, 168, 98, 0)] = std::make_pair(Ipv4Address(0, 0, 9, 1), Ipv4Address(0, 0, 10, 1));
//    networkMap[Ipv4Address(192, 168, 99, 0)] = std::make_pair(Ipv4Address(0, 0, 9, 2), Ipv4Address(0, 0, 9, 3));
//    networkMap[Ipv4Address(192, 168, 100, 0)] = std::make_pair(Ipv4Address(0, 0, 9, 2), Ipv4Address(0, 0, 10, 2));
//    networkMap[Ipv4Address(192, 168, 101, 0)] = std::make_pair(Ipv4Address(0, 0, 9, 3), Ipv4Address(0, 0, 9, 4));
//    networkMap[Ipv4Address(192, 168, 102, 0)] = std::make_pair(Ipv4Address(0, 0, 9, 3), Ipv4Address(0, 0, 10, 3));
//    networkMap[Ipv4Address(192, 168, 103, 0)] = std::make_pair(Ipv4Address(0, 0, 9, 4), Ipv4Address(0, 0, 9, 5));
//    networkMap[Ipv4Address(192, 168, 104, 0)] = std::make_pair(Ipv4Address(0, 0, 9, 4), Ipv4Address(0, 0, 10, 4));
//    networkMap[Ipv4Address(192, 168, 105, 0)] = std::make_pair(Ipv4Address(0, 0, 9, 5), Ipv4Address(0, 0, 9, 6));
//    networkMap[Ipv4Address(192, 168, 106, 0)] = std::make_pair(Ipv4Address(0, 0, 9, 5), Ipv4Address(0, 0, 10, 5));
//    networkMap[Ipv4Address(192, 168, 107, 0)] = std::make_pair(Ipv4Address(0, 0, 9, 6), Ipv4Address(0, 0, 9, 1));
//    networkMap[Ipv4Address(192, 168, 108, 0)] = std::make_pair(Ipv4Address(0, 0, 9, 6), Ipv4Address(0, 0, 10, 6));
//    networkMap[Ipv4Address(192, 168, 109, 0)] = std::make_pair(Ipv4Address(0, 0, 10, 1), Ipv4Address(0, 0, 10, 2));
//    networkMap[Ipv4Address(192, 168, 110, 0)] = std::make_pair(Ipv4Address(0, 0, 10, 1), Ipv4Address(0, 0, 11, 1));
//    networkMap[Ipv4Address(192, 168, 111, 0)] = std::make_pair(Ipv4Address(0, 0, 10, 2), Ipv4Address(0, 0, 10, 3));
//    networkMap[Ipv4Address(192, 168, 112, 0)] = std::make_pair(Ipv4Address(0, 0, 10, 2), Ipv4Address(0, 0, 11, 2));
//    networkMap[Ipv4Address(192, 168, 113, 0)] = std::make_pair(Ipv4Address(0, 0, 10, 3), Ipv4Address(0, 0, 10, 4));
//    networkMap[Ipv4Address(192, 168, 114, 0)] = std::make_pair(Ipv4Address(0, 0, 10, 3), Ipv4Address(0, 0, 11, 3));
//    networkMap[Ipv4Address(192, 168, 115, 0)] = std::make_pair(Ipv4Address(0, 0, 10, 4), Ipv4Address(0, 0, 10, 5));
//    networkMap[Ipv4Address(192, 168, 116, 0)] = std::make_pair(Ipv4Address(0, 0, 10, 4), Ipv4Address(0, 0, 11, 4));
//    networkMap[Ipv4Address(192, 168, 117, 0)] = std::make_pair(Ipv4Address(0, 0, 10, 5), Ipv4Address(0, 0, 10, 6));
//    networkMap[Ipv4Address(192, 168, 118, 0)] = std::make_pair(Ipv4Address(0, 0, 10, 5), Ipv4Address(0, 0, 11, 5));
//    networkMap[Ipv4Address(192, 168, 119, 0)] = std::make_pair(Ipv4Address(0, 0, 10, 6), Ipv4Address(0, 0, 10, 1));
//    networkMap[Ipv4Address(192, 168, 120, 0)] = std::make_pair(Ipv4Address(0, 0, 10, 6), Ipv4Address(0, 0, 11, 6));
//    networkMap[Ipv4Address(192, 168, 121, 0)] = std::make_pair(Ipv4Address(0, 0, 11, 1), Ipv4Address(0, 0, 11, 2));
//    networkMap[Ipv4Address(192, 168, 122, 0)] = std::make_pair(Ipv4Address(0, 0, 11, 1), Ipv4Address(0, 0, 1, 1));
//    networkMap[Ipv4Address(192, 168, 123, 0)] = std::make_pair(Ipv4Address(0, 0, 11, 2), Ipv4Address(0, 0, 11, 3));
//    networkMap[Ipv4Address(192, 168, 124, 0)] = std::make_pair(Ipv4Address(0, 0, 11, 2), Ipv4Address(0, 0, 1, 2));
//    networkMap[Ipv4Address(192, 168, 125, 0)] = std::make_pair(Ipv4Address(0, 0, 11, 3), Ipv4Address(0, 0, 11, 4));
//    networkMap[Ipv4Address(192, 168, 126, 0)] = std::make_pair(Ipv4Address(0, 0, 11, 3), Ipv4Address(0, 0, 1, 3));
//    networkMap[Ipv4Address(192, 168, 127, 0)] = std::make_pair(Ipv4Address(0, 0, 11, 4), Ipv4Address(0, 0, 11, 5));
//    networkMap[Ipv4Address(192, 168, 128, 0)] = std::make_pair(Ipv4Address(0, 0, 11, 4), Ipv4Address(0, 0, 1, 4));
//    networkMap[Ipv4Address(192, 168, 129, 0)] = std::make_pair(Ipv4Address(0, 0, 11, 5), Ipv4Address(0, 0, 11, 6));
//    networkMap[Ipv4Address(192, 168, 130, 0)] = std::make_pair(Ipv4Address(0, 0, 11, 5), Ipv4Address(0, 0, 1, 5));
//    networkMap[Ipv4Address(192, 168, 131, 0)] = std::make_pair(Ipv4Address(0, 0, 11, 6), Ipv4Address(0, 0, 11, 1));
//    networkMap[Ipv4Address(192, 168, 132, 0)] = std::make_pair(Ipv4Address(0, 0, 11, 6), Ipv4Address(0, 0, 1, 6));
//
//
//    networkByRouterID[Ipv4Address(0, 0, 1, 1)] = {Ipv4Address(192, 168, 122, 1), Ipv4Address(192, 168, 2, 2), Ipv4Address(192, 168, 11, 1), Ipv4Address(192, 168, 1, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 1, 2)] = {Ipv4Address(192, 168, 124, 1), Ipv4Address(192, 168, 4, 2), Ipv4Address(192, 168, 1, 1), Ipv4Address(192, 168, 3, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 1, 3)] = {Ipv4Address(192, 168, 126, 1), Ipv4Address(192, 168, 6, 2), Ipv4Address(192, 168, 3, 1), Ipv4Address(192, 168, 5, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 1, 4)] = {Ipv4Address(192, 168, 128, 1), Ipv4Address(192, 168, 8, 2), Ipv4Address(192, 168, 5, 1), Ipv4Address(192, 168, 7, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 1, 5)] = {Ipv4Address(192, 168, 130, 1), Ipv4Address(192, 168, 10, 2), Ipv4Address(192, 168, 7, 1), Ipv4Address(192, 168, 9, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 1, 6)] = {Ipv4Address(192, 168, 132, 1), Ipv4Address(192, 168, 12, 2), Ipv4Address(192, 168, 9, 1), Ipv4Address(192, 168, 11, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 2, 1)] = {Ipv4Address(192, 168, 2, 1), Ipv4Address(192, 168, 14, 2), Ipv4Address(192, 168, 23, 1), Ipv4Address(192, 168, 13, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 2, 2)] = {Ipv4Address(192, 168, 4, 1), Ipv4Address(192, 168, 16, 2), Ipv4Address(192, 168, 13, 1), Ipv4Address(192, 168, 15, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 2, 3)] = {Ipv4Address(192, 168, 6, 1), Ipv4Address(192, 168, 18, 2), Ipv4Address(192, 168, 15, 1), Ipv4Address(192, 168, 17, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 2, 4)] = {Ipv4Address(192, 168, 8, 1), Ipv4Address(192, 168, 20, 2), Ipv4Address(192, 168, 17, 1), Ipv4Address(192, 168, 19, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 2, 5)] = {Ipv4Address(192, 168, 10, 1), Ipv4Address(192, 168, 22, 2), Ipv4Address(192, 168, 19, 1), Ipv4Address(192, 168, 21, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 2, 6)] = {Ipv4Address(192, 168, 12, 1), Ipv4Address(192, 168, 24, 2), Ipv4Address(192, 168, 21, 1), Ipv4Address(192, 168, 23, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 3, 1)] = {Ipv4Address(192, 168, 14, 1), Ipv4Address(192, 168, 26, 2), Ipv4Address(192, 168, 35, 1), Ipv4Address(192, 168, 25, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 3, 2)] = {Ipv4Address(192, 168, 16, 1), Ipv4Address(192, 168, 28, 2), Ipv4Address(192, 168, 25, 1), Ipv4Address(192, 168, 27, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 3, 3)] = {Ipv4Address(192, 168, 18, 1), Ipv4Address(192, 168, 30, 2), Ipv4Address(192, 168, 27, 1), Ipv4Address(192, 168, 29, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 3, 4)] = {Ipv4Address(192, 168, 20, 1), Ipv4Address(192, 168, 32, 2), Ipv4Address(192, 168, 29, 1), Ipv4Address(192, 168, 31, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 3, 5)] = {Ipv4Address(192, 168, 22, 1), Ipv4Address(192, 168, 34, 2), Ipv4Address(192, 168, 31, 1), Ipv4Address(192, 168, 33, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 3, 6)] = {Ipv4Address(192, 168, 24, 1), Ipv4Address(192, 168, 36, 2), Ipv4Address(192, 168, 33, 1), Ipv4Address(192, 168, 35, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 4, 1)] = {Ipv4Address(192, 168, 26, 1), Ipv4Address(192, 168, 38, 2), Ipv4Address(192, 168, 47, 1), Ipv4Address(192, 168, 37, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 4, 2)] = {Ipv4Address(192, 168, 28, 1), Ipv4Address(192, 168, 40, 2), Ipv4Address(192, 168, 37, 1), Ipv4Address(192, 168, 39, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 4, 3)] = {Ipv4Address(192, 168, 30, 1), Ipv4Address(192, 168, 42, 2), Ipv4Address(192, 168, 39, 1), Ipv4Address(192, 168, 41, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 4, 4)] = {Ipv4Address(192, 168, 32, 1), Ipv4Address(192, 168, 44, 2), Ipv4Address(192, 168, 41, 1), Ipv4Address(192, 168, 43, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 4, 5)] = {Ipv4Address(192, 168, 34, 1), Ipv4Address(192, 168, 46, 2), Ipv4Address(192, 168, 43, 1), Ipv4Address(192, 168, 45, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 4, 6)] = {Ipv4Address(192, 168, 36, 1), Ipv4Address(192, 168, 48, 2), Ipv4Address(192, 168, 45, 1), Ipv4Address(192, 168, 47, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 5, 1)] = {Ipv4Address(192, 168, 38, 1), Ipv4Address(192, 168, 50, 2), Ipv4Address(192, 168, 59, 1), Ipv4Address(192, 168, 49, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 5, 2)] = {Ipv4Address(192, 168, 40, 1), Ipv4Address(192, 168, 52, 2), Ipv4Address(192, 168, 49, 1), Ipv4Address(192, 168, 51, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 5, 3)] = {Ipv4Address(192, 168, 42, 1), Ipv4Address(192, 168, 54, 2), Ipv4Address(192, 168, 51, 1), Ipv4Address(192, 168, 53, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 5, 4)] = {Ipv4Address(192, 168, 44, 1), Ipv4Address(192, 168, 56, 2), Ipv4Address(192, 168, 53, 1), Ipv4Address(192, 168, 55, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 5, 5)] = {Ipv4Address(192, 168, 46, 1), Ipv4Address(192, 168, 58, 2), Ipv4Address(192, 168, 55, 1), Ipv4Address(192, 168, 57, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 5, 6)] = {Ipv4Address(192, 168, 48, 1), Ipv4Address(192, 168, 60, 2), Ipv4Address(192, 168, 57, 1), Ipv4Address(192, 168, 59, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 6, 1)] = {Ipv4Address(192, 168, 50, 1), Ipv4Address(192, 168, 62, 2), Ipv4Address(192, 168, 71, 1), Ipv4Address(192, 168, 61, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 6, 2)] = {Ipv4Address(192, 168, 52, 1), Ipv4Address(192, 168, 64, 2), Ipv4Address(192, 168, 61, 1), Ipv4Address(192, 168, 63, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 6, 3)] = {Ipv4Address(192, 168, 54, 1), Ipv4Address(192, 168, 66, 2), Ipv4Address(192, 168, 63, 1), Ipv4Address(192, 168, 65, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 6, 4)] = {Ipv4Address(192, 168, 56, 1), Ipv4Address(192, 168, 68, 2), Ipv4Address(192, 168, 65, 1), Ipv4Address(192, 168, 67, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 6, 5)] = {Ipv4Address(192, 168, 58, 1), Ipv4Address(192, 168, 70, 2), Ipv4Address(192, 168, 67, 1), Ipv4Address(192, 168, 69, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 6, 6)] = {Ipv4Address(192, 168, 60, 1), Ipv4Address(192, 168, 72, 2), Ipv4Address(192, 168, 69, 1), Ipv4Address(192, 168, 71, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 7, 1)] = {Ipv4Address(192, 168, 62, 1), Ipv4Address(192, 168, 74, 2), Ipv4Address(192, 168, 83, 1), Ipv4Address(192, 168, 73, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 7, 2)] = {Ipv4Address(192, 168, 64, 1), Ipv4Address(192, 168, 76, 2), Ipv4Address(192, 168, 73, 1), Ipv4Address(192, 168, 75, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 7, 3)] = {Ipv4Address(192, 168, 66, 1), Ipv4Address(192, 168, 78, 2), Ipv4Address(192, 168, 75, 1), Ipv4Address(192, 168, 77, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 7, 4)] = {Ipv4Address(192, 168, 68, 1), Ipv4Address(192, 168, 80, 2), Ipv4Address(192, 168, 77, 1), Ipv4Address(192, 168, 79, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 7, 5)] = {Ipv4Address(192, 168, 70, 1), Ipv4Address(192, 168, 82, 2), Ipv4Address(192, 168, 79, 1), Ipv4Address(192, 168, 81, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 7, 6)] = {Ipv4Address(192, 168, 72, 1), Ipv4Address(192, 168, 84, 2), Ipv4Address(192, 168, 81, 1), Ipv4Address(192, 168, 83, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 8, 1)] = {Ipv4Address(192, 168, 74, 1), Ipv4Address(192, 168, 86, 2), Ipv4Address(192, 168, 95, 1), Ipv4Address(192, 168, 85, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 8, 2)] = {Ipv4Address(192, 168, 76, 1), Ipv4Address(192, 168, 88, 2), Ipv4Address(192, 168, 85, 1), Ipv4Address(192, 168, 87, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 8, 3)] = {Ipv4Address(192, 168, 78, 1), Ipv4Address(192, 168, 90, 2), Ipv4Address(192, 168, 87, 1), Ipv4Address(192, 168, 89, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 8, 4)] = {Ipv4Address(192, 168, 80, 1), Ipv4Address(192, 168, 92, 2), Ipv4Address(192, 168, 89, 1), Ipv4Address(192, 168, 91, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 8, 5)] = {Ipv4Address(192, 168, 82, 1), Ipv4Address(192, 168, 94, 2), Ipv4Address(192, 168, 91, 1), Ipv4Address(192, 168, 93, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 8, 6)] = {Ipv4Address(192, 168, 84, 1), Ipv4Address(192, 168, 96, 2), Ipv4Address(192, 168, 93, 1), Ipv4Address(192, 168, 95, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 9, 1)] = {Ipv4Address(192, 168, 86, 1), Ipv4Address(192, 168, 98, 2), Ipv4Address(192, 168, 107, 1), Ipv4Address(192, 168, 97, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 9, 2)] = {Ipv4Address(192, 168, 88, 1), Ipv4Address(192, 168, 100, 2), Ipv4Address(192, 168, 97, 1), Ipv4Address(192, 168, 99, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 9, 3)] = {Ipv4Address(192, 168, 90, 1), Ipv4Address(192, 168, 102, 2), Ipv4Address(192, 168, 99, 1), Ipv4Address(192, 168, 101, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 9, 4)] = {Ipv4Address(192, 168, 92, 1), Ipv4Address(192, 168, 104, 2), Ipv4Address(192, 168, 101, 1), Ipv4Address(192, 168, 103, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 9, 5)] = {Ipv4Address(192, 168, 94, 1), Ipv4Address(192, 168, 106, 2), Ipv4Address(192, 168, 103, 1), Ipv4Address(192, 168, 105, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 9, 6)] = {Ipv4Address(192, 168, 96, 1), Ipv4Address(192, 168, 108, 2), Ipv4Address(192, 168, 105, 1), Ipv4Address(192, 168, 107, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 10, 1)] = {Ipv4Address(192, 168, 98, 1), Ipv4Address(192, 168, 110, 2), Ipv4Address(192, 168, 119, 1), Ipv4Address(192, 168, 109, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 10, 2)] = {Ipv4Address(192, 168, 100, 1), Ipv4Address(192, 168, 112, 2), Ipv4Address(192, 168, 109, 1), Ipv4Address(192, 168, 111, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 10, 3)] = {Ipv4Address(192, 168, 102, 1), Ipv4Address(192, 168, 114, 2), Ipv4Address(192, 168, 111, 1), Ipv4Address(192, 168, 113, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 10, 4)] = {Ipv4Address(192, 168, 104, 1), Ipv4Address(192, 168, 116, 2), Ipv4Address(192, 168, 113, 1), Ipv4Address(192, 168, 115, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 10, 5)] = {Ipv4Address(192, 168, 106, 1), Ipv4Address(192, 168, 118, 2), Ipv4Address(192, 168, 115, 1), Ipv4Address(192, 168, 117, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 10, 6)] = {Ipv4Address(192, 168, 108, 1), Ipv4Address(192, 168, 120, 2), Ipv4Address(192, 168, 117, 1), Ipv4Address(192, 168, 119, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 11, 1)] = {Ipv4Address(192, 168, 110, 1), Ipv4Address(192, 168, 122, 2), Ipv4Address(192, 168, 131, 1), Ipv4Address(192, 168, 121, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 11, 2)] = {Ipv4Address(192, 168, 112, 1), Ipv4Address(192, 168, 124, 2), Ipv4Address(192, 168, 121, 1), Ipv4Address(192, 168, 123, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 11, 3)] = {Ipv4Address(192, 168, 114, 1), Ipv4Address(192, 168, 126, 2), Ipv4Address(192, 168, 123, 1), Ipv4Address(192, 168, 125, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 11, 4)] = {Ipv4Address(192, 168, 116, 1), Ipv4Address(192, 168, 128, 2), Ipv4Address(192, 168, 125, 1), Ipv4Address(192, 168, 127, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 11, 5)] = {Ipv4Address(192, 168, 118, 1), Ipv4Address(192, 168, 130, 2), Ipv4Address(192, 168, 127, 1), Ipv4Address(192, 168, 129, 1)};
//    networkByRouterID[Ipv4Address(0, 0, 11, 6)] = {Ipv4Address(192, 168, 120, 1), Ipv4Address(192, 168, 132, 2), Ipv4Address(192, 168, 129, 1), Ipv4Address(192, 168, 131, 1)};
}
...
void Ospfv2Area::addWatches()
{
     ...
     * @sqsq
     */
//    WATCH_MAP(networkMap); // 好像不能WATCH，不然会报错s
}
...
void Ospfv2Area::addInterface(Ospfv2Interface *intf)
{
     ...
     * @sqsq
     */
//    int direction = intf->getInterfaceName()[4] - '0';
//    DesignatedRouterId DR;
//    DR.routerID = parentRouter->getRouterID();
//    DR.ipInterfaceAddress = networkByRouterID[DR.routerID][direction];
//    intf->setDesignatedRouter(DR);
//    intf->setBackupDesignatedRouter(DR);
...
bool Ospfv2Area::floodLSA(const Ospfv2Lsa *lsa, int current_ttl /* = -1 */, Ospfv2Interface *intf, Neighbor *neighbor)
{
    bool floodedBackOut = false;
    for (uint32_t i = 0; i < associatedInterfaces.size(); i++) {
        if (associatedInterfaces[i]->floodLsa(lsa, current_ttl, intf, neighbor)) {
            floodedBackOut = true;
        }
    }
...
void Ospfv2Area::sqsqCalculateShortestPathTree(RouterLsa *calculateRoot, RouterLsa *treeRoot, std::vector<Ospfv2RoutingTableEntry *>& newRoutingTable)
{
    /*
     * @sqsq
     * rfc 2328 section 16.1
     */
...
//    }
    ...
    treeRoot->setDistance(0);
    treeVertices.push_back(treeRoot);
    justAddedVertex = treeRoot; // (1)

    do {
        auto vertexType = static_cast<Ospfv2LsaType>(justAddedVertex->getHeader().getLsType());

        if (vertexType == ROUTERLSA_TYPE) {
            RouterLsa *routerVertex = check_and_cast<RouterLsa *>(justAddedVertex); // @sqsq: routerVertex i.e. V in rfc2328 section 16.1(2)
            ...
            for (uint32_t i = 0; i < linkCount; i++) {
                const auto& link = routerVertex->getLinks(i); // @sqsq: link就是遍历的与每一个相邻节点的链接
                LinkType linkType = static_cast<LinkType>(link.getType());
                Ospfv2Lsa *joiningVertex; // @sqsq: joiningVertex 就是这个链接指向的相邻节点, i.e. W in rfc2328 section 16.1(2)
                ...
                if (candidate != nullptr) { // (2) (d)
                    ...
                    std::vector<NextHop> *newNextHops = calculateNextHops(treeRoot, joiningVertex, justAddedVertex); // (destination, parent)
                    ...
                    else { // @sqsq candidate == nullptr, i.e. it is the first round of iteration
        ...
        else { // @sqsq: choose the vertex belonging to the candidate list that is closest to the root
            unsigned int candidateCount = candidateVertices.size();
...
//            }
            ...
            if (closestVertex->getHeader().getLsType() == ROUTERLSA_TYPE) {
                ...
                if (routerLSA->getB_AreaBorderRouter() || routerLSA->getE_ASBoundaryRouter()) { // @sqsq: rfc2328 section 16.1(4) para 1, but our scheme has only 1 area, no ABR or ASBR
            ...
            if (closestVertex->getHeader().getLsType() == NETWORKLSA_TYPE) { // @sqsq section 16.1(4) para2
                ...
                if ((entry == nullptr) || (overWrite)) {
                    if (entry == nullptr) { // @sqsq section 16.1 para 4
    ...
    for (uint32_t i = 0; i < treeVertices.size(); i++) {
        ...
        for (uint32_t j = 0; j < routerVertex->getLinksArraySize(); j++) {
            ...
            if (entry != nullptr) {
                ...
                std::vector<NextHop> *newNextHops = calculateNextHops(treeRoot, link, routerVertex); // (destination, parent)
                for (auto it = newNextHops->begin(); it != newNextHops->end(); ++it)
                    entry->addNextHop(*it);
                delete newNextHops;
            }
        ...
        std::sort(newRoutingTable.begin(), newRoutingTable.end(),
            [](Ospfv2RoutingTableEntry *entry1, Ospfv2RoutingTableEntry *entry2) {
                if (entry1->getDestination() == entry2->getDestination()) {
                    ...
                    return (entry1->getDestination() < entry2->getDestination());
                }
            }
        );
    }
 ...
 * @sqsq section 16.1.1
 */
std::vector<NextHop> *Ospfv2Area::calculateNextHops(RouterLsa *treeRoot, Ospfv2Lsa *destination, Ospfv2Lsa *parent) const
{
    std::vector<NextHop> *hops = new std::vector<NextHop>; // @sqsq next hop: outgoing interface + IP of next hop router

    RouterLsa *routerLSA = dynamic_cast<RouterLsa *>(parent);
    if (routerLSA != nullptr) {
        if (routerLSA != treeRoot) {
        ...
        if (networkLSA != nullptr) {
            if (networkLSA->getParent() != treeRoot) {
...
std::vector<NextHop> *Ospfv2Area::calculateNextHops(RouterLsa *treeRoot, const Ospfv2Link& destination, Ospfv2Lsa *parent) const
{
 ...
 * @sqsq
 */
void Ospfv2Area::sqsqPrintLSDB()
{
    RouterId currentRouterID = parentRouter->getRouterID();

    std::sort(routerLSAs.begin(), routerLSAs.end(), [](RouterLsa* lsa1, RouterLsa* lsa2){
            return lsa1->getHeader().getLinkStateID() < lsa2->getHeader().getLinkStateID();
        }
    );
    std::sort(networkLSAs.begin(), networkLSAs.end(), [](NetworkLsa* lsa1, NetworkLsa* lsa2){
                return lsa1->getHeader().getLinkStateID() < lsa2->getHeader().getLinkStateID();
            }
        );
    ...
    for (uint32_t i = 0; i < routerLSAs.size(); i++) {
        ...
        const Ospfv2LsaHeader& head = entry->getHeader();
        std::string routerId = head.getAdvertisingRouter().str(false);
        std::cout << "Router LSA in Area " << areaID.str(false) << " in OSPF router with ID " << routerId << std::endl;
        std::cout << "    Link state ID: " << head.getLinkStateID() << std::endl;
        for (unsigned int j = 0; j < entry->getLinksArraySize(); j++) {
            const auto& lEntry = entry->getLinks(j);
            LinkType linkType = static_cast<LinkType>(lEntry.getType());
            if (linkType == POINTTOPOINT_LINK) {
                ...
                std::cout << "        Link connected to: a transit network, DR address (link ID): " << lEntry.getLinkID()
    ...
    // iterate over all networkLSA in all routers inside this area
    for (unsigned int i = 0; i < networkLSAs.size(); i++) {
        std::cout << "Network LSA in Area " << areaID.str(false) << std::endl;
        Ospfv2NetworkLsa *entry = check_and_cast<Ospfv2NetworkLsa *>(networkLSAs[i]);

        // print header info
        const Ospfv2LsaHeader& head = entry->getHeader();
        std::cout << "    Link state ID: " << head.getLinkStateID() << std::endl;
        std::cout << "    Attached routers: ";
        for (unsigned int j = 0; j < entry->getAttachedRoutersArraySize(); j++)
            std::cout << entry->getAttachedRouters(j) << ", ";
        std::cout << endl;
    }
}

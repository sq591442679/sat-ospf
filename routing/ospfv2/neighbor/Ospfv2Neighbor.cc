    ...
    neighborsRouterDeadInterval(40)
{
     ...
     * @sqsq
     */
    WATCH_LIST(linkStateRequestList);
    neighborInitTime = 0.0;
}
...
void Neighbor::processEvent(Neighbor::NeighborEventType event)
{
     ...
     * @sqsq
     */
//    if (state->getState() == LOADING_STATE && event == LOADING_DONE) {
//        parentInterface->getStatePointer()->calculateDesignatedRouter(parentInterface);
//    }
